table 50009 "Item Design Worksheet Line"
{
                ...
                case Type of
                  ...
                  Type::Item:
                    begin
                      ...
                      else if Item."Type of Solder" = Item."Type of Solder" :: DIP then
    ...
    begin
        ...
        else if ProductionBOMLine.Type=ProductionBOMLine.Type::"Production BOM" then
