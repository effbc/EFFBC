                ...
                CASE Type OF
                  Type :: Item:
                    ...
                    IF Item.GET("No.") THEN BEGIN
                      ...
                      //b2b EFF
                      IF NOT((Item."Product Group Code"='STATIONARY') OR (Item."Gen. Prod. Posting Group"='STATIONARY') OR (Item."Item Category Code" ='OFFICE MAI')) THEN
                      BEGIN
                        IF (FORMAT(Item."Gen. Prod. Posting Group")='') OR
                           (FORMAT(Item."Tax Group Code")='') OR
                           (FORMAT(Item."Excise Prod. Posting Group")='') OR
                           (FORMAT(Item."VAT Prod. Posting Group")='') THEN
                        BEGIN
                          NEW_LINE:=10;
                          ...
                          Mail_To:='anilkumar@efftronics.com,erp@efftronics.com,purchase@efftronics.com';
                          USER.RESET;
