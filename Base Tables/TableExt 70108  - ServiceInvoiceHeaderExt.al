...
{
    // version NAVW19.00.00.51852,NAVIN9.00.00.51852,TFS225680
    ...
    fields
    {
        ...
        //Unsupported feature: Change Editable on ""Pre-Assigned No. Series"(Field 107)". Please convert manually.
    ...
    keys
    {
        ...
        //Unsupported feature: Deletion on ""Priority,Response Date,Response Time"(Key)". Please convert manually.
    ...
    */
    ...
    //Unsupported feature: PropertyModification on "Navigate(PROCEDURE 1).NavigateForm(Variable 1000)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "SendRecords(PROCEDURE 6).DocumentSendingProfile(Variable 1001)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "SendRecords(PROCEDURE 6).DummyReportSelections(Variable 1000)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "SendRecords(PROCEDURE 6).ReportDistributionMgt(Variable 1003)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "SendProfile(PROCEDURE 9).DummyReportSelections(Variable 1000)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "SendProfile(PROCEDURE 9).ReportDistributionMgt(Variable 1003)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "PrintRecords(PROCEDURE 2).DocumentSendingProfile(Variable 1002)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "PrintRecords(PROCEDURE 2).DummyReportSelections(Variable 1001)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "ServInvLine(Variable 1005)". Please convert manually.
    ...
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //ServInvLine : "Service Invoice Line";
    //Variable type has not been exported.
