tableextension 70110 ServiceCrMemoHeaderExt extends "Service Cr.Memo Header"
{
    ...
    */
    ...
    //Unsupported feature: PropertyModification on "SendRecords(PROCEDURE 6).ReportDistributionMgt(Variable 1002)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "ServCrMemoLine(Variable 1005)". Please convert manually.
    ...
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //ServCrMemoLine : "Service Cr.Memo Line";
    //Variable type has not been exported.
