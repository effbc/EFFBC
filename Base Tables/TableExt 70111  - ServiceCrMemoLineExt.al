tableextension 70111 ServiceCrMemoLineExt extends "Service Cr.Memo Line"
{
    ...
    keys
    {
        ...
        //Unsupported feature: Deletion on ""Document No.,Type,No."(Key)". Please convert manually.
        ...
        //Unsupported feature: Deletion on ""Document No.,Component Line No."(Key)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "GetCaptionClass(PROCEDURE 38).ServiceCMHeader(Variable 1001)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //GetCaptionClass : 5994;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //GetCaptionClass : "Service Cr.Memo Header";
    //Variable type has not been exported.
    ...
    //Unsupported feature: PropertyModification on "GetCurrencyCode(PROCEDURE 3).ServiceCMHeader(Variable 1000)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //GetCurrencyCode : 5994;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //GetCurrencyCode : "Service Cr.Memo Header";
    //Variable type has not been exported.
