...
{
    // version NAVW19.00.00.51685,NAVIN9.00.00.51685,TFS223871,B2B1.0,Rev01
    ...
    fields
    {
        ...
        //Unsupported feature: Change Data type on ""Ship-to Code"(Field 12)". Please convert manually.
        ...
        //Unsupported feature: Change Editable on ""Posting Date"(Field 20)". Please convert manually.
        ...
        */
        ...
        field(16321; "Subcon. Order No."; Code[20])
        {
    ...
    keys
    {
        ...
        //Unsupported feature: Deletion on ""Vendor Cr. Memo No.,Posting Date"(Key)". Please convert manually.
        ...
        key(PreAss2; "Pre-Assigned No.")
        {
        }
        key(VendorCr3; "Vendor Cr. Memo No.", "Posting Date")
        {
        }
        key(Return4; "Return Order No.")
        {
        }
        key(Buyfrom5; "Buy-from Vendor No.")
        {
        }
        key(Prepay6; "Prepayment Order No.")
        {
        }
        key(PaytoVend7; "Pay-to Vendor No.")
        {
        }
        key(POstingdate8; "Posting Date")
        {
        }
    }
    ...
    */
    ...
    //Unsupported feature: PropertyModification on "ShowCorrectiveInvoice(PROCEDURE 16).PurchInvHeader(Variable 1001)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //ShowCorrectiveInvoice : 122;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //ShowCorrectiveInvoice : "Purch. Inv. Header";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "ShowCancelledInvoice(PROCEDURE 5).PurchInvHeader(Variable 1001)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //ShowCancelledInvoice : 122;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //ShowCancelledInvoice : "Purch. Inv. Header";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "PurchCrMemoHeader(Variable 1000)". Please convert manually.
