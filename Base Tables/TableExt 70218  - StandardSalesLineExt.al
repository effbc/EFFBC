tableextension 70218 StandardSalesLineExt extends "Standard Sales Line"
{
    ...
    fields
    {
        ...
        //Unsupported feature: Change Editable on ""Standard Sales Code"(Field 1)". Please convert manually.
...
/* key(Key1; "Standard Sales Code", "Line No.")
    ...
    */
    ...
    //Unsupported feature: PropertyModification on ""No."(Field 4).OnValidate.Res(Variable 1005)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on ""No."(Field 4).OnValidate.StdSalesCode(Variable 1000)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "GetCurrency(PROCEDURE 2).StdSalesCode(Variable 1000)". Please convert manually.
    ...
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //GetCurrency : "Standard Sales Code";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "StdSalesCode(Variable 1001)". Please convert manually.
    ...
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //StdSalesCode : "Standard Sales Code";
    //Variable type has not been exported.
